"""Click commands for memberships resource"""
...
@click.option('--output', 'output_path', default='./output',
              type=click.Path())
def list_memberships(limit, offset, output_format, output_path):
    """List memberships"""
...
@memberships.command('get')
@click.argument('memberships_id', type=int)
def get_memberships(memberships_id):
